...
namespace Onion_Commerce.Cotizacion
{
    public partial class Frm_Cotizacion : BaseForm
    {
        ...
        private void txt_proveedor_Enter(object sender, EventArgs e)
        {
            ...
            {
                txt_proveedor.Text = buscarCliente.nombre;
                idCliente = buscarCliente.id;
                time_fechaCompra.Focus();
            }
        }
        ...
        private async void RegistrarCotizacion()
        {
            ...
            try
            {
                ...
                if (ok)
                {
                    ...
                    txt_PK.Text = en.IdCotiza;

                    en.IdPed = idPedido;

                    en.FechaCoti = time_fechaCompra.Value;
                    en.TotalCotiza = Convert.ToDouble(lbl_TotalPagar.Text);
                    en.Vigencia = time_fechaVencimiento.Value;
                    en.PrecioconIgv = check_conforme.Checked ? "Si" : "No";
                    en.Condiciones = txt_obs.Text;
                    ...
                    if (ok2)
                    {
                        ...
                        if(check_conforme.Checked == true)
                        {
        ...
        private async void LimpiarForm()
        {
            ...
            txt_PK.Text = RN_TipoDoc.RN_NroID(10);
