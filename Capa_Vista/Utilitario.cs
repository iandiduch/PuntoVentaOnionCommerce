...
namespace Onion_Commerce
{
    class Utilitario
    {
        ...
        public static async Task ChangeBackColor(Control parent,Color oldColor, Color newColor)
        {
            // Verificar si el control tiene el BackColor establecido en WhiteSmoke
            if (parent.BackColor == oldColor)
            {
            ...
            {
                // Llamar recursivamente al método para cada control hijo
                await ChangeBackColor(control, oldColor, newColor);
            }
        }
        ...
        public int Solo_Letras(int Teclas)
        {
            ...
            switch (Teclas) 
            {
                ...
                case 44:
                    ...
                    return Teclas  ;
                default :
                    ErrorLog.MensajeError("Error", "No se Permite Numeros", null);
                    break;
        ...
        public int Solo_NumerosEnteros(int TECLAS)
        {
            switch (TECLAS)
            {
                case 48:
                ...
                default:
                    ...
                    //MessageBox.Show("Por favor No ingreses Letras, Solo se Admiten Numeros" & vbCrLf & "Solo se Admiten Numeros y coma (,) para separar Decimales", "ayuda", _
                    //                MessageBoxButtons.OK)
                    ErrorLog.MensajeError("Error", "Solo se Permiten Numeros Enteros", null);
                    break;
            }
            return TECLAS = 0;
        }
